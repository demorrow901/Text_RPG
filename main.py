...
def show_location_home(game, user_hp,user_xp,user_name, user_money, user_inventory, user_luck, user_level):
    while game:
        os.system("cls")
        ...
        print(f"2 - Отправится на арену")
        print(f"3 - Выйти из игры")

        user_choise = ""
        user_choise = input("Что делать? ")

        if user_choise == "1":
            potion_shop.show_location_shop(user_name, user_money, user_inventory, user_luck, user_level)
        elif user_choise == "2":
            arena.show_location_arena(user_resistanse, user_luck, user_dexterity, user_forse, user_name, user_hp, user_xp, user_level, user_inventory, game)
        elif user_choise == "3":
            game = False
        else:
...
show_location_home(game, user_hp, user_xp, user_name, user_money, user_inventory, user_luck, user_level)
